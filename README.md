<h1 align="center">Hi, I'm Benjamin Morelli-Kirshner</h1>

<p align="center">
  <b>Computer Engineering Student at Concordia University</b>
</p>

<p align="center">
  Interested in systems programming, embedded development, reverse engineering,
  digital signal processing, and the boundary between hardware and software.
</p>

## Technical Focus

- **Systems programming:** C, C++, assembly, memory management, and operating-system internals
- **Embedded systems:** device drivers, hardware interfaces, microcontrollers, and computer architecture
- **Reverse engineering:** binary analysis, low-level debugging, vulnerability research, and exploit mitigation
- **Signal processing:** audio programming and digital signal processing
- **Software engineering:** backend services, API integrations, databases, testing, and containerized deployment
...
- Systems software and operating-system internals
- Embedded systems and device drivers
- Reverse engineering and binary analysis
- Audio and digital signal processing
- CPU architecture and memory systems
- Vulnerability research and software security

I'm always looking to learn, build, and collaborate on interesting technical projects.

## Core Languages and Tools

<p align="center">
  <a href="https://en.cppreference.com/w/c/language" title="C">
    <img src="https://skillicons.dev/icons?i=c" width="40" height="40" alt="C" />
  </a>
  <a href="https://en.cppreference.com/w/cpp/language" title="C++">
...
<p align="center">
  <a href="mailto:hello@benm-k.com"><b>Email</b></a>
  &nbsp;·&nbsp;
  <a href="https://www.linkedin.com/in/benm-k/"><b>LinkedIn</b></a>
</p>
